...
//////////////////////////////////////////////////////////
//異常があった時のコールバック関数
static gboolean bus_watch_callback_old(GstBus* bus, GstMessage* msg, gpointer user_data)
{
...
//////////////////////////////////////////////////////////
// パイプラインの取得
static void media_configure_cb_2(GstRTSPMediaFactory* factory, GstRTSPMedia* media, gpointer user_data)
{
...
//////////////////////////////////////////////////////////
// パイプラインの取得
static void media_configure_cb_1(GstRTSPMediaFactory* factory, GstRTSPMedia* media, gpointer user_data)
{
    GstElement* element = gst_rtsp_media_get_element(media);
    if (!element) return;
...
//////////////////////////////////////////////////////////
//ダミーRTSPクライアントの起動
static gboolean dummy_bus_cb(GstBus* bus, GstMessage* msg, gpointer) {
...
static GstRTSPMedia* prewarm_media_without_client(GstRTSPMediaFactory* factory,
